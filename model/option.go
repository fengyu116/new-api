...
func InitOptionMap() {
	...
	common.OptionMap[setting.AutoGroupStrategyOptionKey] = setting.GetAutoGroupStrategy()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case setting.AutoGroupStrategyOptionKey:
		err = setting.UpdateAutoGroupStrategy(value)
